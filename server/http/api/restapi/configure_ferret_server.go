...
//go:generate swagger generate server --target ../../api --name FerretServer --spec ../../../../api/api.oas2.json --principal models.Principal --exclude-main
...
func configureAPI(api *operations.FerretServerAPI) http.Handler {
	...
	api.XAuthTokenAuth = func(token string) (*models.Principal, error) {
	...
	if api.TokenByCredentialsHandler == nil {
		api.TokenByCredentialsHandler = operations.TokenByCredentialsHandlerFunc(func(params operations.TokenByCredentialsParams) middleware.Responder {
